...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>DFSK</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>DFSK</b> Pontianak</span>
        </a>
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Developed by Siskom Untan
        </div>
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>&copy; {{$date}} - DFSK Management System </strong>
    </footer>
